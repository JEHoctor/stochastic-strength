...
- `SavedWorkoutEditViewModel` delete-on-save rule: an existing workout the user empties and blank-names is silently deleted on back (matches the rule; confirm this is wanted).
